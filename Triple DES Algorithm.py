#install pycrptodome from terminal
#it helps to use functions for cryptography and hashing
#the command is 'pip install cryptodome'

#now we have imported DES3 for encrption/decryption
#also md5 for key
